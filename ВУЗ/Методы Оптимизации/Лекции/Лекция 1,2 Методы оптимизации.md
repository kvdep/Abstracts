...
$f''(x) = \begin{pmatrix} -2 & 0 \\ 0 & -2 \end{pmatrix}; |f''(x)| = 4 \Rightarrow (f'')^{-1}=\frac{1}{4} \begin{pmatrix} -2 & 0 \\ 0 & -2 \end{pmatrix}$ #(почему обратная функция такая простая I forgorrr)
